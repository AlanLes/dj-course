import { RouteData, RoutePoint, Vehicle, Shipment } from '@/model/shipments';
import { Driver, DriverRoute } from '@/model/drivers';
import { Vehicle as VehicleEntity } from '@/model/vehicles';

export const convertDriverRouteToShipment = (driverRoute: DriverRoute, driver: Driver): Shipment => {
...
export const generateVehicleRouteShipments = (vehicle: VehicleEntity): Shipment[] => {
